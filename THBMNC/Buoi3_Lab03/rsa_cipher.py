    ...
    def call_api_generate_keys(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                msg.setText("Tao khoa thanh cong!")
                msg.exec_()
            else:
                print("Loi khi goi API")
    ...
    def call_api_encrypt(self):
        ...
        try: 
            ...
            if response.status_code == 200:
                ...
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Ma hoa thanh cong")
                msg.exec_()
            else:
                print("Loai khi goi API")
        except requests.exceptions.RequestException as e:
            print("Error: %s" % e.message)
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Giai ma thanh cong")
                msg.exec_()
            else:
                print("Loai khi goi API")
        except requests.exceptions.RequestException as e:
        ...
        try: 
            ...
            if response.status_code == 200:
                ...
                if data["is_verified"]:
                    ...
                    msg.setText("That bai")
                    msg.exec_()
            else:
                print("Loi trong khi goi API")
        except requests.exceptions.RequestException as e:
            print("Error: %s" % e.message)
